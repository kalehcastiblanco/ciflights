...
<div class="receipt">
	...
	<header class="header">
		<div class="header__top">
			...
			<div class="header__meta">
				<span class="header__date"><?php echo $_GET["date"] ?></span>
				<span class="header__serial">0f-113</span>
				<span class="header__number">25042016</span>
			</div>
		</div>
		<div class="header__greeting">
			<span class="header__name">Hola, <?php echo $_GET["name"] ?></span>
			<span class="header__count">Te confirmamos que tu compra ha sido exitosa:</span>
	...
	<section class="cart">
			<h2 class="cart__header">Detalles:</h2>
			<ol class="list">
				<li class="list__item">
					<span class="list__name">Tiquetes vuelo</span>
					<span class="list__price">$<?php echo number_format($_GET["total"], 2) ?></span>
				</li>
				<li class="list__item">
					<span class="list__name">Impuestos (15%)</span>
					<span class="list__price">$<?php echo number_format(($_GET["total"]/100*15), 2) ?></span>
				</li>
			</ol>	
			<hr class="cart__hr" />
			<footer class="cart__total">
				<h3 class="cart__total-label">Total</h3>
				<span class="cart__total-price">$<?php echo number_format(($_GET["total"]/100*15)+$_GET["total"], 2) ?></span>				
			</footer>
	</section>
...
<a href="https://dribbble.com/shots/2738907-PayPal-Email-Receipt" target="_blank" class="link">Regresar al sitio del comprador</a>
